...
public class WorkMonthTest {
    ...
    private final Class<WorkDayOutOfRangeException> WORK_DAY_INVALID_EXCEPTION = WorkDayOutOfRangeException.class;
    ...
    void shouldCalculateTotalHoursProperlyWhenWorkDayChanged() {
        ...
        workMonth.changeWorkDays(Set.of(workDay));
        workMonth.calculateTotalHours();
    ...
    @Test
    @DisplayName("WorkMonth Should Not Change WorkDays When Have Not Changed")
    ...
    @Test
    @DisplayName("WorkMonth Should Not Include WorkDays In Calculating Total Hours When 'isLeave' is true")
    void shouldNotIncludeChangedWorkDaysWhenIsLeaveIsTrue() {
        final WorkMonth workMonth = WorkMonth.create(WORK_MONTH_ID, USER_ID, YEAR_MONTH);
